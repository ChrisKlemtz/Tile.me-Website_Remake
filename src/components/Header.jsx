  ...
  return (
    ...
    >
      <nav className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex items-center justify-between">
        ...
        {/* Desktop Navigation & WhatsApp Button */}
        <div className="hidden sm:flex items-center gap-8">
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
        ...
        <div className="sm:hidden flex items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-10 h-10 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-all duration-300 shadow-lg"
            aria-label="WhatsApp kontaktieren"
          >
